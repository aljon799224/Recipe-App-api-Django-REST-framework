...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update(self):
        """test updating with recipe with patch"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """test uploading an meail to recipe"""
    ...
    def test_upload_image_bad_request(self):
        """test uploading as invalid image"""
        url = image_upload_url(self.recipe.id)
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Adobong Chicken')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Sinigang na Baboy')
        recipe2 = sample_recipe(user=self.user, title='Adobong Itlogs')
        ingredient1 = sample_ingredient(user=self.user, name='Baboy')
        ingredient2 = sample_ingredient(user=self.user, name='Itlog')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Beef Steak')
